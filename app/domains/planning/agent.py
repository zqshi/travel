  ...
  "days": [
    {
      ...
      "city": "所在城市",
      "activities": [
        {"name": "景点名", "name_local": "当地语言名", "category": "景点/活动/购物", "address": "地址", "rating": 4.5, "estimated_cost_thb": 500, "source_url": "信息来源URL", "notes": "备注", "phone": "联系电话", "platform": "推荐预定平台", "booking_url": "预定链接"}
      ],
      "transport": [
        {"mode": "地铁/出租/Grab/步行", "from_location": "出发地", "to_location": "目的地", "duration_min": 30, "estimated_cost_thb": 100, "booking_url": "", "platform": ""}
      ],
      "meals": [
        {"name": "餐厅名", "name_local": "当地语言名", "category": "当地菜/海鲜/街头", "address": "地址", "rating": 4.0, "estimated_cost_thb": 300, "source_url": "", "notes": "推荐菜品", "phone": "电话", "platform": "预定平台"}
      ],
